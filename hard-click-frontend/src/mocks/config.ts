...
const MOCK_OVERRIDE: Record<string, boolean> = {
  ...
  schedule: false, // /api/schedule/me·/me/today — 학습 스케줄/오늘 할 일 라이브(2026-07-16). ⚠️ 페르소나 로그인+ALB 배포 상태에서 E2E 미검증. BE 미배포/에러 시 스케줄 화면이 에러남 → 되돌리려면 이 값 true.
  similarQuiz: false, // POST /api/similar-quizzes — 오답 기반 유사문제 라이브(2026-07-16). ⚠️ FE 주석상 "가정 shape·BE 미개발(07-13)" — 라이브 미검증. BE 미준비 시 유사퀴즈 진입이 에러남 → 되돌리려면 이 값 true.
