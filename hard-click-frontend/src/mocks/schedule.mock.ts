...
export const mockTodayTasks: readonly TodayTask[] = [
  ...
  // courseId 1 = mocks/similarQuiz.mock.ts BANK[1](React) — 유사퀴즈 mock과 짝을 맞춤. source='REVIEW'는 BE PR #596 계약.
  { id: 'REVIEW-1', itemId: 1, source: 'REVIEW', title: '지난주 복습 퀴즈', done: false, category: 'REVIEW', startTime: '20:00', endTime: '21:00', courseId: 1 },
];
